...
<body>
    ...
    var naverLogin = new naver.LoginWithNaverId(
            {
                clientId: "{......}",
                callbackUrl: "http://localhost:8080/Five/member/collback.jsp",
                isPopup: true,
                callbackHandle: true
            ...
            if (status) {
                ...
                $.ajax({
                	...
                	success :  function(result) {
                		if(result == 1){
                			location.href = "http://localhost:8080/Five/main.jsp";
                		}
                		else {
                			location.href = "http://localhost:8080/Five/member/login.jsp";
                		}
					}
