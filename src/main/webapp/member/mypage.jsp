...
<body>
				...
				<div class="row">
					...
					<div class="col-md-12 my-3">
						...
						<ul class="list-group text-center my-3 sdmenu">
							 <li  class="list-group-item" onclick="pagechange('member/my_info')">  내 정보 </li>
							 <li  class="list-group-item" onclick="pagechange('member/myboard')">  내가쓴글 </li>
							 <li  class="list-group-item" onclick="pagechange('member/myquestion')">  내 문의 </li>
						</ul>
					</div>
	...
	<script src="/Five/js/mypage.js?ver=220610""></script>
</body>
</html>